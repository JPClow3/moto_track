...
type LayoutRouteId = RouteId | "/(app)/admin" | "/(app)/dashboard" | "/(app)/documents" | "/(app)/expenses" | "/(app)/fuel" | "/(app)/garage" | "/(app)/maintenance" | "/(app)/reminders" | "/(app)/reports" | "/(app)/reports/sale/[motorcycleId]" | "/(app)/tires" | "/(app)/trabalho"
type LayoutParams = RouteParams & { motorcycleId?: string | undefined }

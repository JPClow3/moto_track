...
export const actions = {
  createRecord: async ({ request, locals, platform }: import('./$types').RequestEvent) => {
  ...
  deleteRecord: async ({ request, locals }: import('./$types').RequestEvent) => {
  ...
  repeatLast: async ({ request, locals, platform }: import('./$types').RequestEvent) => {
    const form = await request.formData();
  ...
  ocrScan: async ({ request, platform }: import('./$types').RequestEvent) => {
    const form = await request.formData();
  ...
  importPreview: async ({ request }: import('./$types').RequestEvent) => {
    const form = await request.formData();
  ...
  importConfirm: async ({ request, locals }: import('./$types').RequestEvent) => {
    const form = await request.formData();
  ...
  saveStation: async ({ request, locals }: import('./$types').RequestEvent) => {
    const form = await request.formData();
    const id = String(form.get("id") ?? "");
    const payload = {
      owner_id: locals.user!.id,
  ...
  deleteStation: async ({ request, locals }: import('./$types').RequestEvent) => {
    const form = await request.formData();
    const { error } = await locals.supabase
      .from("fuel_stations")
      .delete()
  ...
  saveGrade: async ({ request, locals }: import('./$types').RequestEvent) => {
    const form = await request.formData();
    const id = String(form.get("id") ?? "");
    const payload = {
      owner_id: locals.user!.id,
  ...
  deleteGrade: async ({ request, locals }: import('./$types').RequestEvent) => {
    const form = await request.formData();
    const { error } = await locals.supabase
      .from("fuel_grades")
      .delete()
  ...
  saveDefaults: async ({ request, locals }: import('./$types').RequestEvent) => {
    const form = await request.formData();
  ...
  saveReviewSettings: async ({ request, locals }: import('./$types').RequestEvent) => {
    const form = await request.formData();
    const { error } = await locals.supabase
      .from("fuel_review_preferences")
      .upsert({

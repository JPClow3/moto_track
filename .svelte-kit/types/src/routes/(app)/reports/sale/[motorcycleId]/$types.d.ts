...
type RouteParams = { motorcycleId: string };
type RouteId = '/(app)/reports/sale/[motorcycleId]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/(app)/reports/sale/[motorcycleId]/+page.server.js').load>>>>>>;

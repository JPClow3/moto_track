...
type RouteId = '/(public)/reports/sale/public/[token]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../../src/routes/(public)/reports/sale/public/[token]/+page.server.js').load>>>>>>;

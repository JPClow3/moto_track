...
const number = (key, label, required = false) => ({ key, label, kind: "number", required });
const bool = (key, label) => ({
  key,
  label,
  kind: "boolean"
});
const motorcycle = (required = true) => ({
  key: "motorcycle_id",
  label: "Motocicleta",
  kind: "select",
  source: "motorcycles",
...
const featureConfigs = {
  garage: {
    slug: "garage",
    title: "Garage",
    subtitle: "Motorcycle profiles, specs, odometer, soft delete, and template-derived setup.",
    table: "motorcycles",
    ownerScoped: true,
    orderBy: "name",
    icon: "Bike",
  ...
  fuel: {
    slug: "fuel",
    title: "Fuel",
    subtitle: "Fill-up history, stations, grades, receipts, defaults, repeats, imports, and review cadence.",
    table: "fuel_records",
    ownerScoped: true,
    orderBy: "date.desc",
    icon: "Fuel",
  ...
  maintenance: {
    slug: "maintenance",
    title: "Maintenance",
    subtitle: "Maintenance records, parts, plan intervals, stock, quick create, photos, and recurring reminders.",
  ...
  tires: {
    slug: "tires",
    title: "Tires",
    subtitle: "Tire catalog, installation history, wear monitoring, pressure logs, and exports.",
    table: "tire_records",
    ownerScoped: true,
  ...
  documents: {
    slug: "documents",
    title: "Documents",
    subtitle: "Document vault with R2-backed files, metadata, expiry tracking, reminders, and exports.",
  ...
  reminders: {
    slug: "reminders",
    title: "Reminders",
    subtitle: "Date, km, and interval reminders with snooze, complete, email, and push notification state.",
    table: "reminders",
    ownerScoped: true,
  ...
  expenses: {
    slug: "expenses",
    title: "Expenses",
    subtitle: "Annual fees, insurance policies, claims, automatic reminders, and CSV export.",
    table: "annual_fees",
    ownerScoped: true,
  ...
  reports: {
    slug: "reports",
    title: "Reports",
    subtitle: "Cost summaries, timeline, detailed CSV, HTML/PDF sale reports, and public share links.",
  ...
  trabalho: {
    slug: "trabalho",
    title: "Work",
    subtitle: "Professional delivery sessions, daily costs, income, distance, and profitability.",
    table: "work_sessions",
    ownerScoped: true,
...
function schemaForFeature(feature) {
  ...
  for (const field of feature.fields) {
    ...
    shape[field.key] = field.required ? validator : validator.optional().or(z.literal(""));
  }
  return z.object(shape);
}
export {
  getFeature as g,
  schemaForFeature as s
};

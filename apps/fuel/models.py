...
class FuelGrade(TimeStampedModel, UserOwnedModel):
	...
	default_price_per_liter = models.DecimalField(max_digits=8, decimal_places=3, null=True, blank=True)
	notes = models.TextField(blank=True)
...
class FuelRecord(TimeStampedModel):
	...
	station = models.ForeignKey(FuelStation, on_delete=models.SET_NULL, null=True, blank=True, related_name="fuel_records")
	fuel_grade = models.ForeignKey(FuelGrade, on_delete=models.SET_NULL, null=True, blank=True, related_name="fuel_records")

...
class MaintenanceModelTests(TestCase):
	def setUp(self):
		...
		self.part = MaintenancePart.objects.create(owner=self.user, name="Filtro de óleo", part_type=MaintenancePartType.FILTER)
		MaintenancePart.objects.create(owner=self.other_user, name="Pastilha", part_type=MaintenancePartType.BRAKE_PAD)

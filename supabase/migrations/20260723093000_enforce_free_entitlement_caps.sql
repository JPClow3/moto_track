-- Enforce Free plan caps at the database so PostgREST clients cannot bypass
-- the SvelteKit entitlement guards.
...
grant execute on function public.owner_has_pro_access(uuid) to authenticated, service_role;

...
urlpatterns = [
    ...
    path("lgpd/", TemplateView.as_view(template_name="legal/lgpd.html"), name="lgpd"),
    path("cancelamento/", TemplateView.as_view(template_name="legal/cancellation.html"), name="cancellation_policy"),

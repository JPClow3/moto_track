  ...
  reminders: {
    ...
    fields: [
      ...
      { key: "description", label: "Descrição", kind: "textarea" },
      {
        ...
        required: true,
        options: [
          { value: "by_km", label: "Por quilometragem" },
          { value: "by_date", label: "Por data" },
          { value: "by_interval", label: "Por intervalo (repete)" },
        ],
      },
      {
        key: "trigger_value_km",
        label: "Avisar com quantos km",
        kind: "number",
        help: "Distância para o aviso (ex.: 500 km antes da revisão).",
      },
      {
        key: "trigger_value_days",
        label: "Avisar com quantos dias",
        kind: "number",
        help: "Dias de antecedência do aviso.",
      },
      {
        key: "reference_km",
        label: "Km de referência",
        kind: "number",
        help: "Odômetro de partida da contagem.",
      },
      {
        key: "reference_date",
        ...
        kind: "date",
        required: false,
        help: "Data de partida da contagem.",
      },
      bool("is_active", "Ativo"),

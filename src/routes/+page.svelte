...
<div class="landing">
  <a class="skip-link" href="#landing-main">{$t("a11y.skipToContent")}</a>
  <!-- ── NAV ───────────────────────────────────────────────── -->
  <PublicHeader />
  ...
  <main id="landing-main" tabindex="-1">
    ...
    <section class="relative overflow-hidden border-b border-[var(--line)]">
      ...
      <div
        class="relative mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 sm:gap-16 sm:px-6 sm:py-20 lg:grid-cols-[1.05fr_.95fr] lg:py-28"
      >
        <div>
          ...
          <h1
            class="reveal display mt-6 text-5xl sm:text-7xl lg:text-8xl"
            style="--d:60ms"
          >
          ...
          <p
            ...
            style="--d:120ms"
          >
            Hodômetro, custos, revisões, documentos e lembretes num só lugar.
            Pare de adivinhar quanto a sua moto custa — e saiba exatamente
                ...
                <li class="flex items-start gap-3 text-sm text-[var(--muted)]">
                  ...
                  <span>
                    {#each item as seg, j (j)}
                      {#if seg.b}<strong class="text-[var(--fg)]"
                          >{seg.t}</strong
                        >{:else}{seg.t}{/if}
                    {/each}
                  </span>
        ...
        <div class="mx-auto max-w-6xl">
          <div class="flex flex-wrap items-end justify-between gap-6">
            <div class="max-w-2xl">
              ...
              <p class="mt-5 text-lg text-[var(--muted)]">
                Guias com torque, intervalo e peça certa — de graça, sem
                precisar de conta.
              </p>
            </div>
    ...
    <!-- ── CTA ───────────────────────────────────────────────── -->
    <section
      class="relative overflow-hidden bg-ink px-6 py-24 text-paper sm:py-28"
    >
      <div class="cta-slashes" aria-hidden="true"></div>
      <div class="relative mx-auto max-w-3xl text-center">
        <h2 class="display text-5xl sm:text-7xl">Pronto para acelerar?</h2>

<script lang="ts">
  ...
  $: freePlan = [
    [
      { t: $t("pricing.freeFeature1Prefix") },
      { t: $t("pricing.freeFeature1Bold"), b: true },
    ],
  ...
  $: proPlan = [
    [
      { t: $t("pricing.proFeature1Bold"), b: true },
      { t: $t("pricing.proFeature1Suffix") },
    ],
    [{ t: $t("pricing.proFeature2Bold"), b: true }],
    [{ t: $t("pricing.proFeature3Bold"), b: true }],
    [
      { t: $t("pricing.proFeature4Bold"), b: true },
      { t: $t("pricing.proFeature4Suffix") },
    ],
  ...
  <div class="relative mx-auto max-w-4xl">
    ...
    <div class="mt-16 grid gap-6 md:grid-cols-2">
      ...
      <div class="panel flex flex-col p-8">
        ...
        <a class="button-secondary w-full" href="/auth"
          >{$t("pricing.freeCta")}</a
        >
      </div>
          ...
          <div class="my-8">
            {#if data.pricing.monthly}
              ...
              <p class="mt-2 text-xs text-paper/50">
                {$t("pricing.perMonth")}
                {#if annualSavings > 0}
                  &middot; {$t("pricing.annualSaves", {
                    amount: formattedAnnualSavings,
                  })}
                {/if}
              </p>
            {:else}

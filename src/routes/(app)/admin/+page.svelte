    ...
    <div class="grid gap-6 xl:grid-cols-2">
      ...
      >
        ...
        <label class="flex items-center gap-2 text-sm"
          ><input type="checkbox" name="is_published" value="true" checked /> Publicado</label
        >
      ...
      >
        ...
        <div class="grid gap-3 sm:grid-cols-2">
          <input
            ...
            placeholder="Marca"
            required
          /><input class="field" name="model" placeholder="Modelo" required />
        </div>
        <div class="grid gap-3 sm:grid-cols-4">
          ...
          /><input
            ...
            placeholder="cc"
            required
          /><input class="field" name="country_code" value="BR" />
        </div>
